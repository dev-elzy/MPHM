...
export default function ScoreEntryPage() {
  ...
  const isLocked = session?.status === 'locked' || (!isMustahiq && !isAdmin);
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          <Link href="/dashboard/sekretariat/akademik/nilai" className="p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
