    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Dashboard Sekretariat</h1>
        ...
        <Card className="glass-panel shadow-premium-3d rounded-2xl">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'Input Nilai', href: '/dashboard/sekretariat/akademik/nilai', icon: BookOpen, color: 'text-[#C9A050]', bg: 'bg-amber-50 dark:bg-amber-500/10' },
                { label: 'Absensi', href: '/dashboard/sekretariat/akademik/absensi', icon: Clock, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-500/10' },
                { label: 'Data Siswi', href: '/dashboard/sekretariat/siswi', icon: GraduationCap, color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-500/10' },
                { label: 'Pengguna', href: '/dashboard/sekretariat/pengguna', icon: Users, color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-500/10' },
                { label: 'Penilaian Akhlaq', href: '/dashboard/sekretariat/akademik/akhlaq', icon: TrendingUp, color: 'text-rose-600', bg: 'bg-rose-50 dark:bg-rose-500/10' },
                { label: 'Kelas Rombel', href: '/dashboard/sekretariat/akademik/kelas', icon: School, color: 'text-indigo-600', bg: 'bg-indigo-50 dark:bg-indigo-500/10' },
              ].map((link) => {
